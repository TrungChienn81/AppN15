    ...
    return (
        <SafeAreaView style={[
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <Animatable.View animation="fadeInUp" delay={300} style={[
                    styles.orderInfoContainer,
                    theme === "dark" && styles.darkCardContainer
                ]}>
                    <Text style={[
                        styles.sectionTitle,
                        theme === "dark" && styles.darkText
                ...
                <Animatable.View animation="fadeInUp" delay={500} style={[
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <View style={[
                                styles.orderItem,
                                theme === "dark" && styles.darkOrderItem
                            ]}>
                                <View style={styles.orderItemDetails}>
                                    ...
                                    <Text style={[
                                        styles.orderItemSubInfo,
                                        theme === "dark" && styles.darkSubText
                                    ]}>
                                        {language === "vi" ? "Màu: " : "Color: "}{item.color} | {language === "vi" ? "Size: " : "Size: "}{item.size}
                                    </Text>
                                </View>
